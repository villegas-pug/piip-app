...
> **Nota de supersesión:** `specs/015-inicializacion-oracle` supersede la frontera destructiva de este FR-039 únicamente para su procedimiento explícito de inicialización Oracle descartable. En ese procedimiento, Hibernate recrea las 19 tablas y el seed DML-only vuelve a cargar identidad y organización sintéticas. Esta nota no reabre ni marca como pendientes las tareas históricas de esta feature.
