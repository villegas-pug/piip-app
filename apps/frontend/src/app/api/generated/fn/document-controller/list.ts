...
export function list(http: HttpClient, rootUrl: string, params: List$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<DocumentResponse>>> {
...
list.PATH = '/portfolio-records/{recordCode}/documents';
