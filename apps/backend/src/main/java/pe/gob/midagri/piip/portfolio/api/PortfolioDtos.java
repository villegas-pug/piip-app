...
public final class PortfolioDtos {
    ...
    public record InitiativeCreateRequest(
        ...
        @NotEmpty @Size(min = 1) List<@Valid ResponsibleUnitInput> responsibleUnits) {}
    ...
    public static final class InitiativeUpdateRequest {
        ...
        @Size(min = 1) @Valid public List<ResponsibleUnitInput> getResponsibleUnits() { return responsibleUnits; }
