...
public class TestResetSchemaFilterProvider implements SchemaFilterProvider, HibernatePropertiesCustomizer {
    public static final List<String> DROP_ORDER = List.of("DOCUMENTO_CONTENIDO", "DOCUMENTO_VERSION", "ARCHIVO_DOCUMENTO", "DOCUMENTO",
        "REGISTRO_UNIDAD_RESPONSABLE", "TAREA_TRABAJO", "NOTIFICACION", "EVENTO_AUDITORIA", "AUDITORIA_ACCESO",
        "REGISTRO_PORTAFOLIO", "ESTADO_PORTAFOLIO", "CONTADOR_CODIGO", "CATALOGO_ITEM", "TIPO_DOCUMENTO", "USUARIO_ROL_AMBITO",
    ...
    public static final List<String> CREATE_ORDER = List.of("CATALOGO", "INSTITUCION", "ROL", "USUARIO",
        ...
        "ESTADO_PORTAFOLIO", "REGISTRO_PORTAFOLIO", "REGISTRO_UNIDAD_RESPONSABLE", "DOCUMENTO", "ARCHIVO_DOCUMENTO", "DOCUMENTO_VERSION", "DOCUMENTO_CONTENIDO",
