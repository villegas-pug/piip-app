...
public class TestResetSchemaFilterProvider implements SchemaFilterProvider, HibernatePropertiesCustomizer {
    public static final List<String> DROP_ORDER = List.of("DOCUMENTO_CONTENIDO", "DOCUMENTO_VERSION", "DOCUMENTO",
        ...
        "REGISTRO_PORTAFOLIO", "CONTADOR_CODIGO", "CATALOGO_ITEM", "TIPO_DOCUMENTO", "CATALOGO");
    public static final List<String> CREATE_ORDER = List.of("CATALOGO", "CATALOGO_ITEM", "TIPO_DOCUMENTO", "CONTADOR_CODIGO",
    ...
    public static final Set<String> PROTECTED_TABLES = Set.of("INSTITUCION", "ROL", "UNIDAD_EJECUTORA", "UNIDAD_ORGANICA", "USUARIO", "USUARIO_ROL_AMBITO");
