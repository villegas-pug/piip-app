...
class HttpParameterBindingTest {
    ...
    void declaresThePublicNameForEveryPathQueryAndMultipartBinding() throws NoSuchMethodException {
        List<Binding> bindings = List.of(
            ...
            binding(DocumentController.class, "upload", 0, PathVariable.class, "recordCode", String.class, DocumentType.class, MultipartFile.class),
            binding(DocumentController.class, "upload", 1, PathVariable.class, "type", String.class, DocumentType.class, MultipartFile.class),
            binding(DocumentController.class, "upload", 2, RequestPart.class, "file", String.class, DocumentType.class, MultipartFile.class),
            binding(DocumentController.class, "notApplicable", 0, PathVariable.class, "recordCode", String.class, DocumentType.class, NotApplicableRequest.class),
            binding(DocumentController.class, "notApplicable", 1, PathVariable.class, "type", String.class, DocumentType.class, NotApplicableRequest.class),
            ...
            binding(PortfolioController.class, "initiatives", 0, RequestParam.class, "q", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 1, RequestParam.class, "status", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 2, RequestParam.class, "executingUnitId", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 3, RequestParam.class, "page", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 4, RequestParam.class, "size", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 5, RequestParam.class, "sort", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "initiatives", 6, RequestParam.class, "direction", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            ...
            binding(PortfolioController.class, "projects", 0, RequestParam.class, "q", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 1, RequestParam.class, "status", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 2, RequestParam.class, "executingUnitId", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 3, RequestParam.class, "page", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 4, RequestParam.class, "size", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 5, RequestParam.class, "sort", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
            binding(PortfolioController.class, "projects", 6, RequestParam.class, "direction", String.class, String.class, Long.class, int.class, int.class, String.class, String.class),
        ...
        assertThat(bindings).hasSize(36);
